...
function RaiseTicket() {
    return ( 
         <div className='container'>
             <h1 className='fs-2 text-center m'>To create a ticket, select a relevant topic</h1>
          ...
          <div className='col-4 p-4 mt-2 mb-2'>
           ...
           <div className='col-4 p-4 mt-5 mb-2'>
             <h4 className=''><i class="fa-solid fa-money-bill-1"></i>Funds</h4>
           ...
           <div className='col-4 p-4 mt-5 mb-2'>
            ...
            <a href='' style={{textDecoration: "none", lineHeight: "2.5"}}>About Coin</a><br/>
             <a href=''  style={{textDecoration: "none", lineHeight: "2.5"}}>Buying and Selling</a><br/>
              <a href=''  style={{textDecoration: "none", lineHeight: "2.5"}}>Starting the SiP</a><br/>
