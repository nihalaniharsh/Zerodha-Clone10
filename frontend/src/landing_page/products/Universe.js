    ...
    return ( 
       <div className='container mt-5 text-center'>
            <div className='row' text-center>
                <h1 className='text-center mt-2'>The Zerodha Universe</h1>
             ...
             <div className="col-4 p-3 mt-5">
              ...
              <div className="col-4 p-3 mt-5">
               <img src= "media/images/dittoLogo.png" style={{width: "43%"}}/>
                              <p className='text-small text-muted'>Thematic investment platform</p>
            </div> 
              <div className="col-4 p-3 mt-5">
              ...
              <button className=' mt-3 p-2 btn btn-primary fs-5 mb-5'style={{width: "20%", margin: "0 auto"}}>Signup Now</button>
        </div>
        </div>
     );
}
